...
float prev_raw, dist_min, dist_max, dist_raw, dist_prev, dist_ema, alpha; // unit: mm
...
// get a distance reading from the USS
  ...
  if (dist_raw == 0) dist_raw = prev_raw;
  prev_raw = dist_raw;
...
// adjust servo position according to the USS read value
  ...
  if (dist_raw <= 180) {
    ...
    myservo.writeMicroseconds((dist_raw - 180) * _DUTY_MAX / 180);
